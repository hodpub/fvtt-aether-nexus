 ...
 * @extends {Actor}
 */
export class AetherNexusActor extends Actor {
  /** @override */
  prepareData() {
  ...
  prepareDerivedData() {
    ...
    const flags = actorData.flags.aethernexus || {};
  }
  ...
  async _preUpdate(data, options, user) {
    ...
    if (data.type == "character" && data.system?.energy?.value == 0 && !this.statuses.has("broken")) {
