 ...
 */
export class AetherNexusActorShipSheet extends AetherNexusBaseActorSheet {
  constructor(options = {}) {
    super(options);
  ...
  static DEFAULT_OPTIONS = {
    classes: ['aether-nexus', 'actor', 'ship'],
    position: {
      width: 800,
      height: 800,
    },
  ...
  static PARTS = {
    header: {
      template: 'systems/aether-nexus/templates/actor/ship-header.hbs',
    },
    tabs: {
    ...
    return parts.reduce((tabs, partId) => {
      ...
      switch (partId) {
        ...
        case 'tabs':
          return tabs;
        default:
          tab.id = partId.toLowerCase();
          tab.label = partId.charAt(0).toUpperCase() + partId.substring(1).toLowerCase();
      }
